  ...
  return (
    <dialog id="AddTaskModal" className="modal">
      <div className="modal-box">
        ...
        >
          <h1 className="text-2xl font-semibold text-blue-800">Add Task</h1>
          {/* title input */}
          ...
          <div className="relative mb-8 w-[80%]">
            ...
            <select
              id="category"
              name="category"
              className="block w-full mt-1 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              defaultValue="to-do"
